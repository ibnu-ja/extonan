<template>
  ...
  >
    ...
    >
      ...
      <v-list dense>
        <!-- FIXME: active class & aria selected -->
        <v-list-item
          to="/"
          :class="{
            'primary white--text v-list-item--active': $page.url === '/'
          }"
        >
          Home
        </v-list-item>
        ...
        <v-list-item
          ...
          :class="{
            'primary white--text v-list-item--active':
              $page.url === route('profile.show')
          }"
        >
          Profile
        </v-list-item>
        <v-list-item
          ...
          :class="{
            'primary white--text v-list-item--active':
              $page.url === route('api-tokens.index')
          }"
        >
          API Tokens
        </v-list-item>
