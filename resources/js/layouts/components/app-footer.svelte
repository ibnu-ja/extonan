...
<footer class="mt-auto py-6">
    ...
    <div
        class="mx-auto flex max-w-screen-2xl flex-col items-center gap-3 px-2 pt-3 text-center text-xs text-muted-foreground sm:px-4"
    >
    ...
    <div
        class="mx-auto flex max-w-screen-2xl flex-col items-center gap-1 px-2 pt-3 text-center text-xs text-muted-foreground sm:px-4"
    >
        <p>
            Running extonan Web <b class="font-semibold text-foreground"
                >{appVersion}</b
            >
            on branch
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="underline hover:text-foreground">{appBranch}</a
            >
            (<a
                href={commitURL}
                target="_blank"
