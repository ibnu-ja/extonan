    ...
    <v-card :rounded="!xs">
      ...
      <v-row class="pa-0">
        ...
        >
          ...
          <v-card-text>
            Ditch Tailwind for Vuetify! This Vue.js library offers stunning Material Design components out-of-the-box,
            letting you build gorgeous, functional UIs with ease.
          </v-card-text>
        </v-col>
        <v-col
          cols="auto"
